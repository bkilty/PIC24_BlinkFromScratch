...
void UART2_Initialize(void) {
    // STSEL 2; IREN disabled; PDSEL 8N; UARTEN enabled; RTSMD enabled; RXINV disabled; USIDL disabled; WAKE disabled; ABAUD disabled; LPBACK disabled; BRGH enabled; UEN TX_RX; 
    U2MODE = 0x8809;
