...
#define TMR3_INTERRUPT_TICKER_FACTOR    1
    ...
    /* use TMR3 to delay for a specified number of milliseconds given a specified system frequency (assumes tmr clock is sysClock/2*/
    void TMR3_delay_ms(uint32_t sysClockSpeed, uint16_t mSec);
